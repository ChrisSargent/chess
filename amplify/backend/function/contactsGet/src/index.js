...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/contactsGet/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var http_method_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! http-method-enum */ "../node_modules/http-method-enum/dist-web/index.js");
...
const createConfig = Authorization => ({
...
const getSessionToken = async () => {
  ...
  const config = { ...createConfig("Basic RGF0YUFQSTphZG1pbg=="),
    method: http_method_enum__WEBPACK_IMPORTED_MODULE_2__["HTTPMethod"].POST,
    url: "/sessions"
  };
  const response = await axios__WEBPACK_IMPORTED_MODULE_3___default()(config);
  return response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : (_response$data$respon = _response$data.response) === null || _response$data$respon === void 0 ? void 0 : _response$data$respon.token;
};

const client = async () => {
  const token = await getSessionToken();
  const config = createConfig(`Bearer ${token}`);
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.create(config);
};
...
const serverErrResponse = {
  ...
  message: Object(http_status_codes__WEBPACK_IMPORTED_MODULE_0__["getReasonPhrase"])(http_status_codes__WEBPACK_IMPORTED_MODULE_0__["INTERNAL_SERVER_ERROR"])
}; // A gateway timeout error

const gwTOutErrResponse = {
  code: http_status_codes__WEBPACK_IMPORTED_MODULE_0__["GATEWAY_TIMEOUT"],
  message: Object(http_status_codes__WEBPACK_IMPORTED_MODULE_0__["getReasonPhrase"])(http_status_codes__WEBPACK_IMPORTED_MODULE_0__["GATEWAY_TIMEOUT"])
};
